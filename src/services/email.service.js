...
// Create transporter for Gmail SMTP (DISABLED FOR DEMO MODE)
/*
...
/**
 * Helper to send email via Gmail SMTP (MOCKED FOR DEMO MODE)
 */
const sendEmail = async ({ to, subject, html }) => {
    try {
        ...
        console.error('[EMAIL-SERVICE-MOCK] Error:', error);
        return false;
    }
};
...
export const sendRegistrationOTPEmail = async (email, otp) => {
    ...
    return await sendEmail({ to: email, subject: 'Foodiegram Account Verification', html });
};
...
export const sendOTPEmail = async (email, otp) => {
    ...
    return await sendEmail({ to: email, subject: 'Foodiegram Creator Login OTP', html });
};
...
export const sendPasswordResetEmail = async (email, resetUrl) => {
    ...
    return await sendEmail({ to: email, subject: 'Foodiegram Password Reset', html });
};
...
export const sendRestaurantVerificationEmail = async (creator, restaurant, token) => {
    ...
    return await sendEmail({ to: adminEmail, subject: 'New Restaurant Verification Request', html });
};
...
export const sendCreatorStatusEmail = async (email, statusMessage) => {
    ...
    `;
    return await sendEmail({ to: email, subject: 'Foodiegram Account Status Update', html });
};
